...
const fetchFourColumnsPageBegin = (state, action) => {
    return {
        ...state,
        loading: true,
        error: null
...
const fetchFourColumnsPageSuccess = (state, action) => {
...
const fetchFourColumnsPageFailur = (state, action) => {
    return {
        ...state,
        loading: false,
        error: action.err,
...
const loadMoreFourColumnsPageDataBegin = (state, action) => {
    return {
        ...state,
...
const loadMoreFourColumnsPageDataSuccess = (state, action) => {
    return {
        ...state,
        loadingMoreData: false,
        // items: action.array
...
const loadMoreFourColumnsPageDataFailur = (state, action) => {
    return {
        ...state,
        loadingMoreData: false,
...
const loadMoreDisableButtonStateForFourColumnsPage = (state, action) => {
    return {
        ...state,
...
const setCategoriesFourColumnsPage = (state, action) => {
    return {
        ...state,
...
const setFourColumnsPageIsHoveringCategoryFromHeader = (state, action) => {
...
const updateItemsStyleValuesFourColumnsPage = (state, action) => {
...
const setActivityOfFourColumnsPageCategoriesFromHeader = (state, action) => {
    let updatedCategories = [...state.categories];
...
const initItemsStylesStateForFourColumnsPage = (state, action) => {
...
const addMoreItemsStylesStateForFourColumnsPage = (state, action) => {
    let updatedItemsStyleValues = {};
    ...
    console.log(updatedItemsTopPosition)
    action.arr.map((el, i) => {
...
const disappearenceAndAppearanceOfElementsDueToTheCategoryFourColumnsPage = (state, action) => {
    return {
        ...state,
...
const setLoadMoreStepFourColumnsPage = (state, action) => {
    return {
        ...state,
...
const setTopPositionOfTheItemForFourColumnsPage = (state, action) => {
    let updatedItemsTopPosition = [...state.itemsTopPosition];
...
const fourColumnsPageReducer = (state = initialState, action) => {
    switch(action.type){
        case actionTypes.FETCH_FOUR_COLUMNS_PAGE_BEGIN:
            return fetchFourColumnsPageBegin (state, action); 
        case actionTypes.FETCH_FOUR_COLUMNS_PAGE_SUCCESS:
            return fetchFourColumnsPageSuccess (state, action);
        case actionTypes.FETCH_FOUR_COLUMNS_PAGE_FAILURE:
            return fetchFourColumnsPageFailur(state, action);
        case actionTypes.LOAD_MORE_FOUR_COLUMNS_PAGE_BEGIN:
            return loadMoreFourColumnsPageDataBegin (state, action); 
        case actionTypes.LOAD_MORE_FOUR_COLUMNS_PAGE_SUCCESS:
            return loadMoreFourColumnsPageDataSuccess (state, action);
        case actionTypes.LOAD_MORE_FOUR_COLUMNS_PAGE_FAILURE:
            return loadMoreFourColumnsPageDataFailur(state, action);
        case actionTypes.LOAD_MORE_DISABLE_BUTTON_STATE_FOR_FOUR_COLUMNS_PAGE:
            return loadMoreDisableButtonStateForFourColumnsPage(state, action);
        case actionTypes.SET_CATEGORIES_FOUR_COLUMNS_PAGE:
            return setCategoriesFourColumnsPage(state, action);
        case actionTypes.SET_FOUR_COLUMNS_PAGE_IS_HOVERING_CATEGORY_FROM_HEADER:
            return setFourColumnsPageIsHoveringCategoryFromHeader(state, action);
        case actionTypes.UPDATED_ITEMS_STYLE_VALUES_FOUR_COLUMNS_PAGE:
            return updateItemsStyleValuesFourColumnsPage(state, action);
        case actionTypes.SET_ACTIVITY_OF_FOUR_COLUMNS_PAGE_CATEGORIES_FROM_HEADER:
            return setActivityOfFourColumnsPageCategoriesFromHeader(state, action);
        case actionTypes.INIT_ITEMS_STYLES_STATE_FOR_FOUR_COLUMNS_PAGE:
            return initItemsStylesStateForFourColumnsPage(state, action);
        case actionTypes.ADD_MORE_ITEMS_STYLES_STATE_FOR_FOUR_COLUMNS_PAGE:
            return addMoreItemsStylesStateForFourColumnsPage(state, action);
        case actionTypes.DISAPPEARANCE_AND_APPEARANCE_OF_ELEMENTS_DUE_TO_THE_CATEGORY_FOUR_COLUMNS_PAGE:
            return disappearenceAndAppearanceOfElementsDueToTheCategoryFourColumnsPage(state, action);
        case actionTypes.SET_LOAD_MORE_STEP_FOUR_COLUMNS_PAGE:
            return setLoadMoreStepFourColumnsPage(state, action);
        case actionTypes.SET_TOP_POSITION_OF_THE_ITEM_FOR_FOUR_COLUMNS_PAGE:
            return setTopPositionOfTheItemForFourColumnsPage(state, action);
        default: 
            return state;
    }
}

export default fourColumnsPageReducer;
