...
export const Tabs: React.FC<Types.TabsProps> = (props) => {
    ...
    const section1Column1Tab1 = React.useRef(null);
    const section1Column1Tab2 = React.useRef(null);
    const section1Column1Tab3 = React.useRef(null);
    const section1Column2Tab1 = React.useRef(null);
    const section1Column2Tab2 = React.useRef(null);
    const section1Column2Tab3 = React.useRef(null);
    const section2Tab1 = React.useRef(null);
    const section2Tab2 = React.useRef(null);
    const section2Tab3 = React.useRef(null);
