...
export type ContactFormPageProps = {
    ...
    setInputFiledValueAndCheckValidationForContactFormPage: (obj: GeneralTypes.InputForm, _event: React.MouseEvent, inputFieldId: number, formName?: string) => {obj: GeneralTypes.InputForm, _event: React.MouseEvent, inputFieldId: number, formName?: string},
