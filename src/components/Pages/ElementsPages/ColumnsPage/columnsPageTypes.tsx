...
export type ColumnsPageProps = {
    columnsPage: GeneralTypes.ColumnsPageState,
    ...
    fetchColumnsPageData: () => void,
    fetchColumnsPageDataSuccess: (array: Array<GeneralTypes.ColumnsPageItem>) => {array: Array<GeneralTypes.ColumnsPageItem>},
